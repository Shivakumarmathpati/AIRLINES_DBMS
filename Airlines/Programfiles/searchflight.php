...
if(isset($_POST['search'])) {
    ...
    if(!empty($source) && !empty($destination) && !empty($date)) {
        $query = mysqli_query($con, "SELECT ARRIVAL, DEPARTURE, DURATION, FLIGHT_CODE, AIRLINE_ID, PRICE_BUSINESS, PRICE_ECONOMY, PRICE_STUDENTS, PRICE_DIFFERENTLYABLED FROM flight WHERE SOURCE='$source' AND DESTINATION='$destination' AND DATE='$date'");
